...
var oe = (e, i, t) =>
    i in e
        ? re(e, i, { enumerable: !0, configurable: !0, writable: !0, value: t })
        : (e[i] = t);
...
class I {
    constructor(i, t) {
        ...
        typeof i == "string"
            ...
            (this._config = t ?? {}),
            this._element != null &&
                St.set(this.constructor.type, this._element, this);
    }
    get config() {
        return this._config ?? {};
    }
    ...
    destroy() {
        (this._destroyed = !0),
            this._element != null &&
                St.remove(this.constructor.type, this._element);
    }
}
o(I, "type", "");
const Lt = {
        ...
        isMouseEventWithinElement(e, i) {
            ...
            return (
                t.x < s.right && t.x > s.left && t.y < s.bottom && t.y > s.top
            );
        },
    ...
    S = class extends I {
        ...
        init() {
            this._element != null &&
                (this._element.classList.add(S.DEFAULT.class.base),
        ...
        initOptions() {
            this._targetElement != null &&
                !this._targetElement.classList.contains(
                    S.DEFAULT.class.hidden
                ) &&
                this._element.classList.add(S.DEFAULT.class.open),
        ...
        get isShown() {
            ...
            return (
                ((t = this._element) == null
                    ? void 0
                    : t.classList.contains(S.DEFAULT.class.open)) ?? !1
            );
        }
        show() {
            this._destroyed ||
                (this.dispatchEvent(S.EVENTS.show),
                this._targetElement != null &&
                    this._element != null &&
                    (this._element.classList.add(S.DEFAULT.class.open),
        ...
        hide() {
            this._destroyed ||
                (this.dispatchEvent(S.EVENTS.hide),
                this._targetElement != null &&
                    this._element != null &&
                    (this._element.classList.remove(S.DEFAULT.class.open),
                    (this._targetElement.style.height = `${this._targetElement.scrollHeight}px`),
                    Lt.afterTransition(this._targetElement, () => {
                        this.isShown ||
        ...
        getTargetElement() {
            ...
            const t =
                this.config.target ??
                this._element.getAttribute(S.DEFAULT.attr.target);
...
let C = S;
o(C, "type", "collapse"),
    o(C, "SELECTOR", '[data-fc-type="collapse"]'),
    o(C, "EVENTS", {
        ...
        if (this._element != null) {
            ...
            if (!s)
                ...
                this.targetCollapses = t
                    .filter((a) => a.getAttribute(Tt.DEFAULT.attr.parent) == n)
                    .map((a) => C.getInstanceOrCreate(a));
            }
            this.initListeners();
        }
    }
...
let Z = Tt;
o(Z, "type", "accordion"),
    o(Z, "SELECTOR", '[data-fc-type="accordion"]'),
    o(Z, "DEFAULT", {
        attr: {
...
function Ht(e, i, t) {
    ...
    const a = s.x + s.width / 2 - n.width / 2,
...
const ce = async (e, i, t) => {
    ...
    let h = await l.getElementRects({ reference: e, floating: i, strategy: n }),
        { x: f, y: c } = Ht(h, s, d),
        m = s,
        g = {},
        E = 0;
    for (let u = 0; u < r.length; u++) {
        const { name: L, fn: w } = r[u],
            {
                x: y,
                y: b,
                data: D,
...
async function zt(e, i) {
    ...
    const { x: s, y: n, platform: a, rects: l, elements: r, strategy: d } = e,
        ...
        b = ((await (a.isElement == null ? void 0 : a.isElement(y))) &&
        ...
        D = yt(
            a.convertOffsetParentRelativeRectToViewportRelativeRect
                ? await a.convertOffsetParentRelativeRectToViewportRelativeRect(
                      { rect: w, offsetParent: y, strategy: d }
                  )
                : w
        );
    return {
...
const fe = (e) => ({
        ...
        async fn(i) {
            ...
            const f = qt(s),
                ...
                b = r.reference[g] + r.reference[m] - c[m] - r.floating[g],
                D = c[m] - r.reference[m],
                k = await (d.getOffsetParent == null
                    ? void 0
                    : d.getOffsetParent(t));
            let H = k ? k[y] : 0;
            (H && (await (d.isElement == null ? void 0 : d.isElement(k)))) ||
                (H = h.floating[y] || r.floating[g]);
            const Y = b / 2 - D / 2,
                G = f[L],
                ot = H - E[g] - f[w],
                V = H / 2 - E[g] / 2 + Y,
                ...
                R =
                    gt(l) != null &&
                    V != A &&
                    r.reference[g] / 2 - (V < G ? f[L] : f[w]) - E[g] / 2 < 0;
            return {
                [m]: c[m] - (R ? (V < G ? G - V : ot - V) : 0),
                data: { [m]: A, centerOffset: V - A },
            };
        },
    }),
...
function ue(e, i, t) {
    ...
    let l =
        n === "x"
            ...
            : "top";
    return (
        i.reference[a] > i.floating[a] && (l = wt(l)), { main: l, cross: wt(l) }
    );
}
        ...
        return (
            e === void 0 && (e = {}),
            {
                ...
                async fn(i) {
                    ...
                    if (
                        ((Y = [...Y, { placement: s, overflows: H }]),
                        !H.every((A) => A <= 0))
                    ) {
                        var G, ot;
                        const A =
                                (((G = n.flip) == null ? void 0 : G.index) ||
                                    0) + 1,
                            R = D[A];
                        if (R)
                            return {
                                data: { index: A, overflows: Y },
                                reset: { placement: R },
                            };
                        let Q =
                            (ot = Y.filter((B) => B.overflows[0] <= 0).sort(
...
function Xt() {
    ...
    return e && Array.isArray(e.brands)
        ? ((Et = e.brands.map((i) => i.brand + "/" + i.version).join(" ")), Et)
        : navigator.userAgent;
}
function N(e) {
...
function _t(e) {
    ...
    return (
        /auto|scroll|overlay|hidden|clip/.test(i + s + t) &&
...
function Ot(e) {
    const i = /firefox/i.test(Xt()),
        t = $(e),
        s = t.backdropFilter || t.WebkitBackdropFilter;
    return (
        t.transform !== "none" ||
        t.perspective !== "none" ||
        (!!s && s !== "none") ||
        ...
        ["transform", "perspective"].some((n) => t.willChange.includes(n)) ||
...
function rt(e) {
    ...
    const t = i.getBoundingClientRect(),
        { width: s, height: n, fallback: a } = Yt(i);
    let l = (a ? vt(t.width) : t.width) / s,
        r = (a ? vt(t.height) : t.height) / n;
    return (
...
function ft(e, i, t, s) {
    ...
    const h = r ? U(r) : window,
        f = Ct() && t;
    let c =
            (l.left +
                ((f &&
                    ((n = h.visualViewport) == null ? void 0 : n.offsetLeft)) ||
                    0)) /
            d.x,
        m =
            (l.top +
                ((f &&
                    ((a = h.visualViewport) == null ? void 0 : a.offsetTop)) ||
                    0)) /
            d.y,
        g = l.width / d.x,
        E = l.height / d.y;
    if (r) {
        ...
        for (; w && s && L !== u; ) {
            const y = rt(w),
                ...
                D = getComputedStyle(w);
            (b.x += (w.clientLeft + parseFloat(D.paddingLeft)) * y.x),
                (b.y += (w.clientTop + parseFloat(D.paddingTop)) * y.y),
                (c *= y.x),
                (m *= y.y),
                (g *= y.x),
                (E *= y.y),
...
function ee(e, i) {
    ...
    i === void 0 && (i = []);
    const s = te(e),
        n = s === ((t = e.ownerDocument) == null ? void 0 : t.body),
        a = U(s);
    return n
        ? i.concat(a, a.visualViewport || [], _t(s) ? s : [])
        : i.concat(s, ee(s));
}
function Pt(e, i, t) {
    let s;
    if (i === "viewport")
        ...
        s = (function (l) {
            ...
            return (
                $(h).direction === "rtl" &&
                    (m += dt(r.clientWidth, h.clientWidth) - f),
                { width: f, height: c, x: m, y: g }
            );
        })(K(e));
    else if (J(i))
        s = (function (l, r) {
            const d = ft(l, !0, r === "fixed"),
                h = d.top + l.clientTop,
        ...
        if (Ct()) {
            ...
            const r = U(e);
            (l.x -=
                ((n = r.visualViewport) == null ? void 0 : n.offsetLeft) || 0),
                (l.y -=
                    ((a = r.visualViewport) == null ? void 0 : a.offsetTop) ||
                    0);
        }
        s = l;
    }
...
function jt(e, i) {
    ...
    if (!N(e)) return t;
    let s = Wt(e, i);
    for (; s && we(s) && $(s).position === "static"; ) s = Wt(s, i);
    return s &&
        (X(s) === "html" ||
            (X(s) === "body" && $(s).position === "static" && !Ot(s)))
        ? t
        : s ||
              (function (n) {
                  let a = mt(n);
...
const Te = {
        getClippingRect: function (e) {
            ...
            const a =
                ...
                d = l.reduce((h, f) => {
                    const c = Pt(i, f, n);
                    return (
                        (h.top = dt(c.top, h.top)),
                        (h.right = Bt(c.right, h.right)),
                        (h.bottom = Bt(c.bottom, h.bottom)),
                        (h.left = dt(c.left, h.left)),
                        h
                    );
                }, Pt(i, r, n));
            return {
        ...
        async getElementRects(e) {
            ...
            const n = this.getOffsetParent || jt,
                a = this.getDimensions;
            return {
                reference: ve(i, await n(t), s),
    ...
    T = class extends I {
        ...
        hide() {
            ...
            this.dispatchEvent(T.EVENTS.hide),
                ...
                this._targetElement != null &&
                    ...
                    this._targetElement.classList.remove(T.DEFAULT.class.open),
                    this._targetElement.classList.add(T.DEFAULT.class.hidden)),
        ...
        initOptions() {
            ...
            if (
                ...
                (s = this._targetElement) == null ||
                    s.classList.add(T.DEFAULT.class.base),
                ...
                ((n = this._targetElement) == null
                    ? void 0
                    : n.classList.contains(T.DEFAULT.class.hidden)) === !1 &&
                    this.show(),
            ...
            (t = this._element) == null ||
                ...
                window.addEventListener("click", (n) => {
                    if (
                        ...
                        (this._autoclose == "inside" && a) || this.hide();
                    }
                });
        }
        addComputePositionInTargetElement() {
            ...
            this._element != null &&
                ...
                ie(this._element, this._targetElement, {
...
let P = T;
o(P, "type", "dropdown"),
    o(P, "SELECTOR", '[data-fc-type="dropdown"]'),
    o(P, "EVENTS", {
...
const Vt = class extends I {
    ...
    init() {
        if (this._element != null) {
            const t = /* @__PURE__ */ new Map(),
                s = this._element.querySelectorAll("[data-fc-target]");
            for (const n of s) {
    ...
    showTab(t) {
        const s = this._elements.get(t),
            n = Array.from(this._elements.keys()).filter((l) => l != t),
...
let tt = Vt;
o(tt, "type", "tab"),
    o(tt, "SELECTOR", '[data-fc-type="tab"]'),
    o(tt, "DEFAULT", {
        attr: {
            target: "data-fc-target",
        },
...
const x = class extends I {
    ...
    initOptions() {
        ...
        let t =
            (s = this._element) == null
                ? void 0
                : s.getAttribute(x.DEFAULT.attr.behavior);
        t
    ...
    show() {
        if (
            ...
            (document.body.style.paddingRight =
                ...
                document.body.classList.add(x.DEFAULT.class.overflowHidden),
                this._element.classList.add(x.DEFAULT.class.open),
                this._targetElement.classList.remove(x.DEFAULT.class.hidden),
                setTimeout(() => {
    ...
    hide() {
        ...
        this.dispatchEvent(x.EVENTS.hide),
            this._targetElement != null &&
                this.isShown &&
                (document.body.classList.remove(x.DEFAULT.class.overflowHidden),
                (t = this._element) == null ||
...
const v = class extends I {
    ...
    get isShown() {
        ...
        return !(
            (t = this._targetElement) != null &&
            t.classList.contains(v.DEFAULT.class.hidden)
        );
    }
    get isClickTrigger() {
    ...
    show() {
        this.computeTooltipPosition(),
            this.dispatchEvent(v.EVENTS.show),
            this._targetElement != null &&
                this._element != null &&
                (this._targetElement.classList.remove(v.DEFAULT.class.hidden),
                this._targetElement.classList.remove(v.DEFAULT.class.opacity0),
                setTimeout(() => {
                    this._element.classList.add(v.DEFAULT.class.open),
                        this._targetElement.classList.add(v.DEFAULT.class.open),
                        this._targetElement.classList.add(
                            v.DEFAULT.class.opacity100
                        );
                }, 1)),
            this.dispatchEvent(v.EVENTS.shown);
    }
    hide() {
        var t;
        this.dispatchEvent(v.EVENTS.hide),
            this._targetElement != null &&
                ((t = this._element) == null ||
                    t.classList.remove(v.DEFAULT.class.open),
                this._targetElement.classList.add(v.DEFAULT.class.opacity0),
                this._targetElement.classList.remove(
                    v.DEFAULT.class.opacity100
                ),
                this._targetElement.classList.add(v.DEFAULT.class.hidden)),
            this.dispatchEvent(v.EVENTS.hidden);
    }
    toggle() {
        this.isShown ? this.hide() : this.show();
    }
    ...
    initOptions() {
        ...
        if (
            ((t = this._element) != null &&
                t.hasAttribute(v.DEFAULT.attr.placement) &&
                (this.config.placement =
                    (s = this._element) == null
                        ? void 0
                        : s.getAttribute(v.DEFAULT.attr.placement)),
            (n = this._element) != null &&
                n.hasAttribute(v.DEFAULT.attr.trigger) &&
                (this.config.trigger =
                    ((a = this._element) == null
                        ? void 0
                        : a.getAttribute(v.DEFAULT.attr.trigger)) === "click"
                        ? "click"
                        : "hover"),
            (l = this._element) != null &&
                l.hasAttribute(v.DEFAULT.attr.offset))
        ) {
    ...
    computeTooltipPosition() {
        const t = [
            Jt(this._targetOffset),
            ye({ padding: 2 }),
            pe({ fallbackStrategy: "bestFit" }),
        ];
        this._arrowElement && t.push(fe({ element: this._arrowElement })),
            this._element != null &&
                this._targetElement != null &&
                (this._targetElement.classList.add(v.DEFAULT.class.absolute),
                this._arrowElement &&
                    this._arrowElement.classList.add(v.DEFAULT.class.absolute),
                ie(this._element, this._targetElement, {
                        ...
                        const { x: f, y: c } = a.arrow,
                            m =
                                f != null
                                    ? `${f}px`
                                    : `${
                                          -this._arrowElement.offsetWidth / 2
                                      }px`,
                            g =
                                c != null
                                    ? `${c}px`
                                    : `${
                                          -this._arrowElement.offsetHeight / 2
                                      }px`,
                            E = {
                                left:
...
const _ = class extends I {
    ...
    init() {
        ...
        this._element != null &&
            ((this._targetElement = this.getTargetElement()),
            (t = this._targetElement) == null ||
                t.classList.add(_.DEFAULT.class.base),
            this.initOptions(),
            this.initListener());
    }
    initOptions() {
        ...
        let t =
            (a = this._element) == null
                ? void 0
                : a.getAttribute(_.DEFAULT.attr.scroll);
        t
        ...
        let s =
            (l = this._element) == null
                ? void 0
                : l.getAttribute(_.DEFAULT.attr.backdrop);
        s
            ? (this.config.backdrop = s !== "false")
            : this.config.backdrop == null && (this.config.backdrop = !0);
        let n =
            (r = this._element) == null
                ? void 0
                : r.getAttribute(_.DEFAULT.attr.behavior);
        n
            ? (this.config.behavior = n == "static" ? "static" : "default")
            : this.config.behavior == null &&
              (this.config.behavior = "default");
    }
    initListener() {
        ...
        this._element != null &&
            ...
            (t = this._targetElement) == null ||
                t
                    .querySelectorAll(`[${_.DEFAULT.attr.dismiss}]`)
                    .forEach((s) => {
                        s.addEventListener("click", () => {
                            this.hide();
                        });
    ...
    get isShown() {
        ...
        return !(
            (t = this._targetElement) != null &&
            t.classList.contains(_.DEFAULT.class.hidden)
        );
    }
    get isStatic() {
        return this.config.behavior === "static";
    ...
    show() {
        if (
            (this.dispatchEvent(_.EVENTS.show),
            this._targetElement != null &&
                this._element != null &&
                (this._targetElement.classList.remove(_.DEFAULT.class.hidden),
                this._element.classList.add(_.DEFAULT.class.open),
    ...
    hide() {
        var t;
        this.isShown &&
            (this.dispatchEvent(_.EVENTS.hide),
            this._targetElement != null &&
                this.isShown &&
                ((t = this._element) == null ||
                    t.classList.remove(_.DEFAULT.class.open),
                this._targetElement.classList.remove(_.DEFAULT.class.open),
                Lt.afterTransition(this._targetElement, () => {
                    this._targetElement.classList.add(_.DEFAULT.class.hidden),
    ...
    getTargetElement() {
        ...
        const t =
            this.config.target ??
            this._element.getAttribute(_.DEFAULT.attr.target);
        return typeof t == "string"
            ? p.findOrById(t)
            : t instanceof HTMLElement
            ? t
...
const at = class extends I {
    ...
    hide() {
        this.dispatchEvent(at.EVENTS.hide),
            this._targetElement != null &&
                this._targetElement.classList.add(at.DEFAULT.class.hidden),
            this.dispatchEvent(at.EVENTS.hidden);
    }
    _getTargetElement() {
        if (this._element == null) return null;
        const t =
            this.config.target ??
            this._element.getAttribute(at.DEFAULT.attr.target);
        return typeof t == "string"
            ? p.findOrById(t)
            : t instanceof HTMLElement
            ? t
...
const be = {
    ...
    bt = class {
        ...
        static init() {
            (this._initialize = this.retrieveFromLocal()),
                (this._old_state = be.deepClone(this._state));
        }
        ...
        static retrieveFromLocal() {
            ...
            return (
                Object.keys(t).forEach((s) =>
                    t[s] == null ? (t[s] = this.defaultState[s]) : void 0
                ),
                (this._state = t),
                !0
            );
        ...
        static notifyListener() {
            for (const i of this._listener) i(bt.state);
        }
    };
let F = bt;
o(F, "_old_state", null),
    o(F, "_initialize", !1),
    o(F, "stateKey", "frost.app_state"),
    o(F, "defaultState", { theme: "light" }),
    o(F, "_listener", []),
    o(F, "_state", bt.defaultState);
class et {
    static init() {
        F.attachListener(this.themeChangeListener),
            this.themeChangeListener(F.state);
    }
        ...
        i.theme == "system"
            ? (et.changeTheme(
              ...
              window
                  ...
                  .addEventListener("change", et.windowThemeListener))
            : (et.changeTheme(i.theme),
              window
                  .matchMedia("(prefers-color-scheme: dark)")
                  .removeEventListener("change", et.windowThemeListener));
    }
...
const it = class extends I {
    ...
    notifyThemeChanged(t) {
        ...
        if (this.trigger != "switch")
            (s = this._element) == null ||
                s.classList.remove("light-theme", "dark-theme", "system-theme"),
                (n = this._element) == null || n.classList.add(`${t}-theme`);
    ...
    init() {
        this._element != null &&
            (this._element.classList.add(it.DEFAULT.class.base),
            (this.theme = p.getAttribute(
                this._element,
                it.DEFAULT.attr.theme,
                this.config.theme
            )),
            (this.trigger = p.getAttribute(
                this._element,
                it.DEFAULT.attr.trigger,
                this.config.trigger
            )),
            this.initListeners(),
            this.notifyThemeChanged(F.state.theme));
    }
    initListeners() {
        var t;
        if (
            ...
            s == null ||
                s.addEventListener("change", (n) => {
                    F.changeTheme(s.checked ? "dark" : "light"),
                        this.setOtherSwitch();
                });
        } else
            this.theme != null &&
    ...
    setOtherSwitch() {
        ...
        p.findAll(it.SELECTOR)
            .map((s) => it.getInstanceOrCreate(s))
            .forEach((s) => {
...
let lt = it;
o(lt, "type", "theme_switcher"),
    o(lt, "SELECTOR", '[data-fc-type="theme_switcher"]'),
    o(lt, "DEFAULT", {
        class: {
            base: "fc-theme",
        },
...
const xt = class {
    static get instance() {
        return (
            this._instance == null && (this._instance = new xt()),
            this._instance
        );
    }
    init() {
        typeof window < "u" &&
            ...
            xt.instance.awakeComponents());
    }
    awakeComponents() {
        [C, Z, P, tt, W, q, j, z, lt].map((i) =>
